<template>
  <section id="contact" class="mx-4 md:mx-auto" v-scroll-reveal.reset>
    <div class="">
        ...
        <form id="contact-form" class="mx-auto" method="POST" action="https://formspree.io/f/xknperzd">
          <div>
            ...
            <input id="form-name"
                   ...
                   name="name" required type="text" :placeholder="`Your full name`.toLocaleLowerCase()">
          </div>
          <div class="mt-8">
          ...
          <div class="mt-8">
            ...
            <textarea id="form-message" :placeholder="`Message`.toLocaleLowerCase()" name="message" required
