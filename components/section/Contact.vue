<template>
  <section id="contact" class="mx-4 md:mx-auto">
    <div class="">
      <div
        class="grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-light-navy text-light-slate rounded-lg shadow-lg"
      >
        <div class="flex flex-col justify-between">
          <div>
            <h2 class="numbered-heading">{{ $t('contact-me') }}</h2>
            <h3
              class="text-4xl lg:text-5xl text-center md:text-left font-bold leading-tight text-lightest-slate"
            >
              {{ $t('lets-talk') }}
            </h3>
        ...
        >
          <div>
            <span class="uppercase text-sm text-lightest-slate font-bold">{{
              $t('your-full-name')
            }}</span>
            <input
              id="form-name"
              ...
              required
              type="text"
              :placeholder="$t('your-full-name').toLocaleLowerCase()"
            />
          </div>
          <div class="mt-8">
            <span class="uppercase text-sm text-lightest-slate font-bold">{{
            ...
            <input
              id="form-email"
              class="w-full bg-transparent text-green-500 border-2 border-green-500 rounded-lg mt-2 p-3 focus:outline-none focus:shadow-outline"
              :placeholder="$t('your-email').toLocaleLowerCase()"
              name="email"
              required
              type="email"
            />
          ...
          <div class="mt-8">
            ...
            <input
              id="form-subject"
              class="w-full bg-transparent text-green-500 border-2 border-green-500 rounded-lg mt-2 p-3 focus:outline-none focus:shadow-outline"
              :placeholder="$t('subject').toLocaleLowerCase()"
              name="subject"
              required
              type="text"
            />
          ...
          <div class="mt-8">
            ...
            <textarea
              id="form-message"
              :placeholder="$t('message').toLocaleLowerCase()"
              name="message"
              required
              class="w-full h-32 bg-transparent text-green-500 border-2 border-green-500 rounded-lg mt-2 p-3 focus:outline-none focus:shadow-outline"
            ></textarea>
          </div>
          <div class="mt-8">
            <button
...
const formBackend = computed(() => {
  return config.FORMSPREE;
});
</script>
