<template>
  <div class="text-lightest-slate hover:text-gray-600 cursor-pointer" @click.prevent="generalStore.toggleTheme()"
       data-cypress="switchTheme">
    <svg v-if="generalStore.theme === 'light'" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
